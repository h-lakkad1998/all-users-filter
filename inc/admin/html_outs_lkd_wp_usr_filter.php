    ...
    <div class="lkd_wp_usr_fltr_modal-content">
        ...
        <div>
            ...
            <div id="lkd_wp_usr_fltr-general-settings" class="lkd_wp_usr_fltr-tabcontent lkd_us_general" style="display:block;" >
                <div class="stng-title"><h2><?php _e("General Filter", LKD_WP_USR_TEXT_DOMAIN ); ?></h2></div>
                        ...
                        <div class="form-field pad-top-40 ordr-by-fields" >
                            ...
                            <div class="form-order" >
                                <label class="fancy-radio" >
                                    <input type="radio" name="ordr-by" value="1" <?php echo ( $ordr_by ===  "1" || $ordr_by == "" ) ? " checked" : ""; ?> ><?php _e("ASCENDING", LKD_WP_USR_TEXT_DOMAIN ); echo "    "; ?>
            ...
            <div class="txt-center" ><h3><?php _e("Multiple Date Filter", LKD_WP_USR_TEXT_DOMAIN ); ?></h3></div>
                <div class="form-field pad-top-40" >
                    <div>
            ...
            <div id="lkd_wp_usr_fltr-advanced-settings" class="lkd_wp_usr_fltr-tabcontent lkd_us_advance" style="display:none;">
                <div id="LETS-make-POST-Form" class="stng-title"><h2><?php _e("Advanced Filters",LKD_WP_USR_TEXT_DOMAIN) ?></h2></div>
                <div>
                    <div>
                        <div class="txt-center" ><h3><?php _e("Meta Filter", LKD_WP_USR_TEXT_DOMAIN ); ?></h3></div>
                        <div class="form-field pad-top-40" >
